...
from src.anc.fxnlms import FxNLMS, train_fxnlms_algorithm
...
def main():
    ...
    # 1. Save Original
    file_original = os.path.join('result', 'anc', '1_original.wav')
    ...
    file_std = os.path.join('result', 'anc', '2_standard_nlms.wav')
    ...
    file_cnn = os.path.join('result', 'anc', '3_hybrid_cnn.wav')
    ...
    file_res = os.path.join('result', 'anc', '4_hybrid_resnet.wav')
